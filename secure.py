...
# --- кризисные мед-рамки ---
CRISIS_MSG = (
    "💙 Похоже, тебе сейчас очень тяжело. Я не могу помочь с этим, но рядом есть люди, которые могут.\n\n"
    "• Нидерланды: 113 Zelfmoordpreventie - 0800-0113 (бесплатно, круглосуточно)\n"
    "• Экстренно: 112\n\n"
    "Пожалуйста, позвони им или близкому человеку прямо сейчас. Ты важен."
)
