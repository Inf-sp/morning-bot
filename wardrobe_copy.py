...
Пиши одним естественным предложением. Не повторяй слова «комплект», «образ» или «палитра» в одной фразе.
Не используй механические обороты «составляют основу комплекта», «светлый цвет обуви» и скобки с названием вещи.
