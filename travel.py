...
def _home_kb():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🧭 10 фактов", callback_data="a_trav_facts")],
...
Отбери 10 самых сильных фактов из собранных: без банальностей и повторов, без факта без подтверждения,
без спорных обобщений. Факты должны относиться минимум к 5 разным темам. Не давай несколько почти
...
def _facts_kb(has_more_hint=True):
    rows = [[InlineKeyboardButton("✨ Ещё 10", callback_data="a_trav_facts_more"),
