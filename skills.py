...
SKILLS = {s.name: s for s in (
    ...
    Skill("wardrobe_feedback", "Гардероб", "card",
          entrypoints=("m_wardrobe", "w_look", "w_improve", "w_check", "wardrobe_check"),
    ...
    Skill("evening_review", "Мысли и вечернее закрытие", "card",
          entrypoints=("as_daycheck", "thought_*", "плановый запуск"),
