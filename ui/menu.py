...
_SCREENS = {
    ...
    "m_afisha": (
        "🎭",
        "Афиша",
        "Мероприятия под твой вкус — выбери категорию.",
        [
            [("🎫 Концерты", "a_concerts_find")],
            [("🎪 Фестивали", "a_afisha_festivals")],
            [("🎭 Театры", "a_afisha_theatre")],
            [("😂 Стендап", "a_afisha_comedy")],
            [("🖼️ Выставки", "a_afisha_exhibitions")],
            [("◀️ Назад", "m_leisure")],
        ],
    ),
    "m_leisure_settings": (
