...
_SCREENS = {
    ...
    "m_movie": (
        "🎬",
        "Кино",
        "Подберу фильм или сериал под твой вкус; можно сразу сузить выбор до жанра.",
        [
            [("✨ Подобрать кино", "movie_reco")],
            [("🎭 По жанру", "movie_genre_menu")],
    ...
    "m_books": (
        "📚",
        "Книги",
        "Подберу книгу под твой вкус или помогу выбрать направление по жанру.",
        [
            [("✨ Подобрать книгу", "book_reco")],
            [("🎭 По жанру", "book_genre_menu")],
