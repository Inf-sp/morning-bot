...
def welcome():
    ...
    b.blank()
    b.text_line("Помогаю с погодой, одеждой, языками, рецептами, досугом и полезными привычками.")
    b.blank()
    b.bold("Разделы")
    b.newline()
    b.text_line("☀️ Мой день — погода, сводка и советы.\n")
    b.text_line("👕 Гардероб — что надеть и покупки.\n")
    b.text_line("🚑 Здоровье — мотивация, тревоги и здоровье.\n")
    b.text_line("📚 Обучение — языки, игра и практика.\n")
    b.text_line("🍿 Досуг — фильмы, книги, музыка и поездки.\n")
    b.text_line("🥣 Готовка — рецепты и идеи из продуктов.\n")
    b.newline()
    b.text_line("Просто напиши вопрос в чат и я помогу 💬")
    b.blank()
