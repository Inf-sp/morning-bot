...
def menu_screen(key):
    ...
    if key == "m_learn":
        return ("📚 Обучение\n\nОбъясню любую тему простыми словами и без воды.\n\n"
                "Можно спросить про:\n• Нидерландский язык\n• Английский язык\n• Дизайн и UX\n• Технологии\n• Историю и науку\n\n"
                "Напиши вопрос или выбери 👇\n\nУровень языка меняется в настройках: /setup", _ikb([
            [("🇳🇱 Нидерландский", "m_nl"), ("🇬🇧 Английский", "m_en")],
            [("🕵️ Игра-детектив", "a_game"), ("🗂️ Словарь", "a_dict")],
            [("🎯 Подготовка к экзамену", "a_exam")],
            [("✍️ Письма и тексты", "as_letter"), ("💡 Идея", "as_idea")],
            _back(),
        ]))
    if key == "m_nl":
        return ("🇳🇱 Нидерландский", _ikb([
            [("📖 Грамматика", "a_gram_nl"), ("📝 Переведи предложение", "a_tr_nl")],
            [("🔤 Глагол дня", "a_verb_nl"), ("💬 Пословица", "a_proverb_nl")],
            [("🗣 Выражение дня", "a_expr_nl"), ("⚙️ Уровень", "a_levels")],
            [("⬅️ Назад", "m_learn")],
        ]))
    if key == "m_en":
        return ("🇬🇧 Английский", _ikb([
            [("📖 Грамматика", "a_gram_en"), ("📝 Переведи предложение", "a_tr_en")],
