...
WELCOME = (
    ...
    "🍃 <b>Самозабота</b> — мотивация, тревоги и здоровье.\n"
    "📚 <b>Обучение</b> — языки, игра и практика.\n"
    "🍿 <b>Досуг</b> — фильмы, книги, музыка и поездки.\n"
    "🥣 <b>Готовка</b> — рецепты и идеи из продуктов.\n\n"
    "Просто напиши вопрос в чат — я помогу 💬\n\n"
    "Всё сохранённое и настройки находятся в разделе 🎚️ <b>Настройки</b>."
)

# Нижнее меню: Мой день широкий первый + категории в два столбца
MAIN_LABELS = ["☀️ Мой день", "👕 Гардероб", "🍃 Самозабота", "📚 Обучение", "🍿 Досуг", "🥣 Готовка", "🎚️ Настройки"]
...
def menu_screen(key):
    if key == "m_wardrobe":
        return (
            ...
            + _MENU_FOOTER,
            _ikb([
                [("✨ Образ на сегодня", "w_look"), ("🧥 Разбор гардероба", "w_improve")],
