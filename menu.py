...
def menu_screen(key):
    ...
    if key == "m_leisure":
        return ("🍿 <b>Досуг</b>\n\nФильмы, музыка, книги и путешествия - под твой вкус.\n\nВыбери 👇", _ikb([
            ...
            [("🎸 Музыка и концерты", "m_music")],
            [("✈️ Путешествия", "m_travel")],
            [("📖 Книги", "a_read")],
            _back(),
        ]))
    if key == "m_music":
        return ("🎸 <b>Музыка и концерты</b>\n\nНовая музыка под твой вкус и концерты твоих артистов.\n\nВыбери 👇", _ikb([
            [("🎵 Что послушать", "a_listen")],
            [("🔎 Поиск по концертам", "a_concerts_find")],
            [("⬅️ Назад", "m_leisure")],
        ]))
    if key == "m_travel":
        return ("✈️ <b>Путешествия</b>\n\nКуда поехать дальше - под твой вкус.\n\nВыбери 👇", _ikb([
