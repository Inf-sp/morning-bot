...
TRAVEL_FACTS_CACHE_KEY = "travel_facts_cache.json"  # глобальный кэш подборок «Интересные факты» по ISO-коду страны, TTL 30 дней
TRAVEL_FACTS_SEEN_KEY = "travel_facts_seen.json"    # {cid: {iso: [id, ...]}} — какие факты пользователь уже видел
TRAVEL_HOME_FACTS_KEY = "travel_home_facts.json"    # {cid: {"week": iso_week, "countries_hash": ..., "facts": [...]}} — 3 факта о посещённых странах на главном экране «Поездки»
